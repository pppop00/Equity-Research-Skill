...
This is an **AI skill pack** built on the **Anamnesis Pattern** — cross-session institutional memory plus scheduled adversarial review. The "code" is primarily markdown files that instruct AI assistants (Claude, ChatGPT, Cursor) how to produce equity research reports under a closed-loop enforcement contract.
